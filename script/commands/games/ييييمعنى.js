...
module.exports.config = {
  ...
  aliases: [],
    ...
    hasPermssion: 0,
    credits: "Ayman ♛",
    description: "معاني كلمات انجليزيه",
    usages: ["لعبة"],
...
const questions = [
  ...
  { question: "brown", answer: "بني اسود" },
  ...
  { question: "guava", answer: "جوافة" },
  { question: "Banana", answer: "موز" },
  { question: "mango", answer: "مانجو" },
  { question: "Apple", answer: "تفاح" },
  { question: "Tomato", answer: "طماطم" },
  { question: "orange", answer: "برتقال" },
  { question: "Cabbage", answer: "كرنب" },
  { question: "grapes", answer: "عنب" },
  { question: "Potato", answer: "بطاطس" },
  { question: "date", answer: "تاريخ" },
  { question: "onions", answer: "بصل" },
  { question: "fig", answer: "تين" },
  { question: "cucumber", answer: "خيار" },
  { question: "watermelon", answer: "بطيخ" },
  
  { question: "corn", answer: "ذرة" },
  { question: "shall", answer: "سوف" },
 
  { question: "under", answer: "تحت" },
  { question: "slow", answer: "بطيء" },
  { question: "problem", answer: "المشكلة" },
  { question: "suspicion", answer: "اشتباه" },
  { question: "against", answer: "مقابل" },
  { question: "well", answer: "حسنا" },
  { question: "never", answer: "أبدا" },
  { question: "fragment", answer: "شظية" },
  { question: "all", answer: "الكل" },
  { question: "most", answer: "معظم" },
  { question: "local", answer: "المحلي" },
  { question: "rice", answer: "أرز" },
  { question: "pear", answer: "كمثري" },
  { question: "Carrot", answer: "جزر" },
  { question: "peach", answer: "خوخ" },
  { question: "Strawberry", answer: "فراولة" },
  { question: "Egg-plant", answer: "باذنجان" },
  { question: "Pine-apple", answer: "أناناس" },
  { question: "olive", answer: "زيتون" },
  { question: "wheat", answer: "قمح" },
  { question: "lollipop", answer: "مصاصة" },
  { question: "Flour", answer: "دقيق" },
  { question: "Candies", answer: "حلويات" },
  { question: "corn", answer: "ذرة" },
  { question: "sandwich", answer: "ساندوتش" },
  { question: "meat", answer: "لحمة" },
  { question: "water", answer: "ماء" },
  { question: "fish", answer: "سمك" },
  { question: "tea", answer: "شاي" },
  { question: "egg", answer: "بيض" },
  { question: "jam", answer: "مربي" },
  { question: "milk", answer: "لبن" },
  { question: "cheese", answer: "جبنة" },
  { question: "bread", answer: "خبز" },
  { question: "juice", answer: "عصير" },
  { question: "beans", answer: "فول" },
  { question: "beach", answer: "شاطئ" },
  { question: "house", answer: "منزل" },
  { question: "Pyramids", answer: "أهرمات" },
  { question: "School", answer: "مدرسة" },
  { question: "park", answer: "حديقة" },
  { question: "Class", answer: "فصل" },
...
module.exports.handleReply = async function ({ api, event, handleReply, Currencies }) {
    ...
    if (userAnswer === correctAnswer) {
        ...
        api.sendMessage(`تهانينا ${userName} عرفت معنى الكلمة وكسبت 100 دولار`, event.threadID);
...
module.exports.run = async function ({ api, event, args }) {
    ...
    const message = `ما معى كلمة: ${question}`;
